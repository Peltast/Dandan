...
HX_STACK_ARG(defaultBitmap,"defaultBitmap")
{
	...
	HX_STACK_LINE(25)
	::actors::Animation tmp2 = ::actors::Animation_obj::__new(HX_HCSTRING("Inactive","\x8b","\xd3","\xe1","\x43"),(int)0,tmp,(int)16,(int)16,Array_obj< ::Dynamic >::__new().Add(tmp1),null());		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(25)
	...
	HX_STACK_LINE(26)
	::actors::Animation tmp5 = ::actors::Animation_obj::__new(HX_HCSTRING("Active","\xe6","\xb5","\xda","\x4a"),(int)0,tmp3,(int)16,(int)16,Array_obj< ::Dynamic >::__new().Add(tmp4),null());		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(26)
	...
	HX_STACK_LINE(33)
	::actors::ObjectMover tmp8 = ::actors::ObjectMover_obj::__new((int)0,(int)0,(int)0,(int)0,(int)0,(int)0,(int)0,(int)0,(int)0,null(),null());		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(33)
