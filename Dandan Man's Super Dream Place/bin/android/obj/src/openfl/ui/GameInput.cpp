...
::openfl::ui::GameInputDevice GameInput_obj::__getDevice( ::lime::ui::Gamepad gamepad){
	...
	if ((tmp4)){
		...
		HX_STACK_LINE(53)
		int tmp7 = gamepad->id;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(53)
		::String tmp8 = ::lime::ui::Gamepad_obj::lime_gamepad_get_device_name(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(53)
		::openfl::ui::GameInputDevice tmp9 = ::openfl::ui::GameInputDevice_obj::__new(tmp6,tmp8);		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(53)
		::openfl::ui::GameInputDevice device = tmp9;		HX_STACK_VAR(device,"device");
		HX_STACK_LINE(54)
		::haxe::ds::ObjectMap tmp10 = ::openfl::ui::GameInput_obj::__devices;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(54)
		::lime::ui::Gamepad tmp11 = gamepad;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(54)
		::openfl::ui::GameInputDevice tmp12 = device;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(54)
		tmp10->set(tmp11,tmp12);
		HX_STACK_LINE(55)
		::haxe::ds::ObjectMap tmp13 = ::openfl::ui::GameInput_obj::__devices;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(55)
		Dynamic tmp14 = ((Dynamic)(tmp13));		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(55)
		int tmp15 = ::Lambda_obj::count(tmp14,null());		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(55)
		::openfl::ui::GameInput_obj::numDevices = tmp15;
	}
	HX_STACK_LINE(59)
