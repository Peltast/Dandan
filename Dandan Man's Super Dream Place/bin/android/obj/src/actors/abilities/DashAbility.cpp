...
HX_STACK_THIS(this)
{
	...
	hitBoxes->push(tmp);
	HX_STACK_LINE(25)
	::actors::ObjectMover tmp1 = ::actors::ObjectMover_obj::__new(((Float).5),((Float).1),(int)-15,(int)0,(int)0,(int)0,(int)60,(int)60,(int)0,(int)0,false);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(24)
	::actors::attacks::Attack tmp2 = ::actors::attacks::Attack_obj::__new(tmp1,hitBoxes,(int)15,(int)3,(int)20,HX_HCSTRING("Dash","\x72","\x81","\x3c","\x2d"),HX_HCSTRING("DashRest","\xa6","\xa9","\x3f","\x06"),true);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(24)
	this->leftDash = tmp2;
	HX_STACK_LINE(29)
	...
	hitBoxes->push(tmp3);
	HX_STACK_LINE(33)
	::actors::ObjectMover tmp4 = ::actors::ObjectMover_obj::__new(((Float).5),((Float).1),(int)15,(int)0,(int)0,(int)0,(int)60,(int)60,(int)0,(int)0,false);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(32)
	::actors::attacks::Attack tmp5 = ::actors::attacks::Attack_obj::__new(tmp4,hitBoxes,(int)15,(int)3,(int)20,HX_HCSTRING("Dash","\x72","\x81","\x3c","\x2d"),HX_HCSTRING("DashRest","\xa6","\xa9","\x3f","\x06"),true);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(32)
	this->rightDash = tmp5;
	HX_STACK_LINE(36)
