...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(24)
	::actors::ObjectMover tmp1 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),(int)0,(int)0,(int)0,(int)0,(int)3,(int)3,(int)0,(int)1,false);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(24)
	::actors::attacks::Attack tmp2 = ::actors::attacks::Attack_obj::__new(tmp1,this->aoeHitBox,(int)-1,(int)1,(int)0,HX_HCSTRING("Launch","\x53","\x76","\xa7","\x8a"),HX_HCSTRING("LaunchRest","\x07","\x23","\x5d","\xb3"),true);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(24)
	this->aoeAttack = tmp2;
	HX_STACK_LINE(26)
...
Void LaunchAbility_obj::retainVelocity( ::actors::ObjectMover mover){
{
		...
		HX_STACK_LINE(42)
		::actors::ObjectMover tmp4 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),tmp,tmp1,tmp2,tmp3,(int)2,(int)5,(int)0,(int)1,false);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(42)
		::actors::ObjectMover floatMovement = tmp4;		HX_STACK_VAR(floatMovement,"floatMovement");
		HX_STACK_LINE(44)
		::actors::attacks::Attack tmp5 = ::actors::attacks::Attack_obj::__new(floatMovement,this->aoeHitBox,(int)-1,(int)1,(int)40,HX_HCSTRING("Launch","\x53","\x76","\xa7","\x8a"),HX_HCSTRING("LaunchRest","\x07","\x23","\x5d","\xb3"),true);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(44)
		this->aoeAttack = tmp5;
		HX_STACK_LINE(46)
