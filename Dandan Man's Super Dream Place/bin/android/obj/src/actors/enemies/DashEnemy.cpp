...
HX_STACK_ARG(homespawn,"homespawn")
{
	...
	HX_STACK_LINE(25)
	::actors::Animation tmp5 = ::actors::Animation_obj::__new(HX_HCSTRING("Idle","\x34","\xd3","\x8c","\x30"),(int)20,tmp,tmp1,tmp2,Array_obj< ::Dynamic >::__new().Add(tmp3).Add(tmp4),null());		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(25)
	...
	HX_STACK_LINE(27)
	::actors::Animation tmp11 = ::actors::Animation_obj::__new(HX_HCSTRING("DashLeft","\x99","\x56","\x48","\x02"),(int)1,tmp6,tmp7,tmp8,Array_obj< ::Dynamic >::__new().Add(tmp9).Add(tmp10),null());		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(27)
	...
	HX_STACK_LINE(29)
	::actors::Animation tmp19 = ::actors::Animation_obj::__new(HX_HCSTRING("DashRight","\x0a","\x7d","\x10","\x74"),(int)1,tmp14,tmp15,tmp16,Array_obj< ::Dynamic >::__new().Add(tmp17).Add(tmp18),null());		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(29)
	...
	HX_STACK_LINE(38)
	::actors::ObjectMover tmp21 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),(int)0,(int)0,(int)0,(int)0,(int)2,(int)60,(int)2,null(),null());		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(38)
	...
	hits->push(tmp29);
	HX_STACK_LINE(50)
	::actors::ObjectMover tmp30 = ::actors::ObjectMover_obj::__new(((Float).5),((Float).1),(int)-15,(int)0,(int)0,(int)0,(int)60,(int)60,(int)0,(int)0,false);		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(49)
	::actors::attacks::Attack tmp31 = ::actors::attacks::Attack_obj::__new(tmp30,hits,(int)15,(int)1,(int)20,HX_HCSTRING("DashLeft","\x99","\x56","\x48","\x02"),null(),null());		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(49)
	this->leftDash = tmp31;
	HX_STACK_LINE(53)
	...
	hits->push(tmp32);
	HX_STACK_LINE(57)
	::actors::ObjectMover tmp33 = ::actors::ObjectMover_obj::__new(((Float).5),((Float).1),(int)15,(int)0,(int)0,(int)0,(int)60,(int)60,(int)0,(int)0,false);		HX_STACK_VAR(tmp33,"tmp33");
	HX_STACK_LINE(56)
	::actors::attacks::Attack tmp34 = ::actors::attacks::Attack_obj::__new(tmp33,hits,(int)15,(int)1,(int)20,HX_HCSTRING("DashRight","\x0a","\x7d","\x10","\x74"),null(),null());		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(56)
