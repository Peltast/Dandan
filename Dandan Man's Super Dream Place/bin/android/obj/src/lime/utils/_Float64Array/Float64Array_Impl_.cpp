...
::lime::utils::ArrayBufferView Float64Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","subarray",0x21ecbb22,"lime.utils._Float64Array.Float64Array_Impl_.subarray","lime/utils/Float64Array.hx",95,0x73d83bc7)
...
int Float64Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","get_length",0xa8e8fff8,"lime.utils._Float64Array.Float64Array_Impl_.get_length","lime/utils/Float64Array.hx",109,0x73d83bc7)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(109)
...
Float Float64Array_Impl__obj::__get( ::lime::utils::ArrayBufferView this1,int idx){
	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","__get",0x92c4aacd,"lime.utils._Float64Array.Float64Array_Impl_.__get","lime/utils/Float64Array.hx",114,0x73d83bc7)
	HX_STACK_ARG(this1,"this1")
	...
	HX_STACK_LINE(115)
	{
		...
		HX_STACK_LINE(115)
		tmp = ::__hxcpp_memory_get_double(this1->buffer->b,(this1->byteOffset + (idx * (int)8)));
	}
	HX_STACK_LINE(115)
	return tmp;
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Float64Array_Impl__obj,__get,return )

Float Float64Array_Impl__obj::__set( ::lime::utils::ArrayBufferView this1,int idx,Float val){
	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","__set",0x92cdc5d9,"lime.utils._Float64Array.Float64Array_Impl_.__set","lime/utils/Float64Array.hx",120,0x73d83bc7)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(idx,"idx")
	...
	HX_STACK_LINE(121)
	{
		...
		bool littleEndian = true;		HX_STACK_VAR(littleEndian,"littleEndian");
		HX_STACK_LINE(121)
		::__hxcpp_memory_set_double(this1->buffer->b,(this1->byteOffset + (idx * (int)8)),val);
		HX_STACK_LINE(121)
		tmp = val;
	}
	HX_STACK_LINE(121)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,__set,return )
