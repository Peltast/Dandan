...
::lime::utils::_ArrayBufferView::TAError TAError_obj::RangeError;
...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("lime.utils._ArrayBufferView.TAError","\xa2","\x1f","\x94","\x4d"), hx::TCanCast< TAError_obj >,sStaticFields,sMemberFields,
