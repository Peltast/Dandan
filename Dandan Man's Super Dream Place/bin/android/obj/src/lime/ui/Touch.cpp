...
::lime::app::Event Touch_obj::onEnd;

::lime::app::Event Touch_obj::onMove;

::lime::app::Event Touch_obj::onStart;
...
bool Touch_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"onEnd") ) { onEnd=ioValue.Cast< ::lime::app::Event >(); return true; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"onMove") ) { onMove=ioValue.Cast< ::lime::app::Event >(); return true; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"onStart") ) { onStart=ioValue.Cast< ::lime::app::Event >(); return true; }
	}
	return false;
}
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::lime::app::Event*/ ,(void *) &Touch_obj::onEnd,HX_HCSTRING("onEnd","\xfc","\x97","\x64","\x32")},
	{hx::fsObject /*::lime::app::Event*/ ,(void *) &Touch_obj::onMove,HX_HCSTRING("onMove","\xd0","\xeb","\xea","\xea")},
	{hx::fsObject /*::lime::app::Event*/ ,(void *) &Touch_obj::onStart,HX_HCSTRING("onStart","\xc3","\x12","\x49","\x1a")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	onEnd= ::lime::app::Event_obj::__new();
	onMove= ::lime::app::Event_obj::__new();
	onStart= ::lime::app::Event_obj::__new();
}
