	...
	HX_STACK_ARG(lazy,"lazy")
{
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(297)
			Dynamic tmp7 = ::cpp::Lib_obj::load(tmp4,tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(297)
			return tmp7;
			HX_STACK_LINE(301)
			::haxe::ds::StringMap tmp8 = ::lime::_system::System_obj::__moduleNames;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(301)
			...
			if ((tmp10)){
				HX_STACK_LINE(304)
				::haxe::ds::StringMap tmp11 = ::lime::_system::System_obj::__moduleNames;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(304)
				...
				HX_STACK_LINE(304)
				Dynamic tmp17 = ::cpp::Lib_obj::load(tmp14,tmp15,tmp16);		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(304)
				return tmp17;
			}
			HX_STACK_LINE(329)
			...
			HX_STACK_LINE(331)
			::String tmp14 = (HX_HCSTRING("./","\x41","\x28","\x00","\x00") + library);		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(331)
			...
			HX_STACK_LINE(331)
			Dynamic tmp18 = ::lime::_system::System_obj::tryLoad(tmp14,tmp15,tmp16,tmp17);		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(331)
			result = tmp18;
			HX_STACK_LINE(333)
			...
			if ((tmp19)){
				HX_STACK_LINE(335)
				::String tmp20 = (HX_HCSTRING(".\\","\x6e","\x28","\x00","\x00") + library);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(335)
				...
				HX_STACK_LINE(335)
				Dynamic tmp24 = ::lime::_system::System_obj::tryLoad(tmp20,tmp21,tmp22,tmp23);		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(335)
				result = tmp24;
			}
			HX_STACK_LINE(339)
			...
			if ((tmp20)){
				...
				HX_STACK_LINE(341)
				Dynamic tmp25 = ::lime::_system::System_obj::tryLoad(tmp21,tmp22,tmp23,tmp24);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(341)
				result = tmp25;
			}
			HX_STACK_LINE(345)
			...
			if ((tmp21)){
				HX_STACK_LINE(347)
				::String tmp22 = ::lime::_system::System_obj::sysName();		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(347)
				::String tmp23 = tmp22.substr((int)7,null());		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(347)
				::String tmp24 = tmp23.toLowerCase();		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(347)
				bool tmp25 = (tmp24 == HX_HCSTRING("windows","\x83","\xde","\x74","\xe8"));		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(347)
				::String tmp26;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(347)
				if ((tmp25)){
					HX_STACK_LINE(347)
					tmp26 = HX_HCSTRING("\\","\x5c","\x00","\x00","\x00");
				}
				else{
					HX_STACK_LINE(347)
					tmp26 = HX_HCSTRING("/","\x2f","\x00","\x00","\x00");
				}
				HX_STACK_LINE(347)
				::String slash = tmp26;		HX_STACK_VAR(slash,"slash");
				HX_STACK_LINE(348)
				::String tmp27 = ::lime::_system::System_obj::findHaxeLib(HX_HCSTRING("lime","\x15","\x17","\xb3","\x47"));		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(348)
				::String haxelib = tmp27;		HX_STACK_VAR(haxelib,"haxelib");
				HX_STACK_LINE(350)
				bool tmp28 = (haxelib != HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(350)
				if ((tmp28)){
					HX_STACK_LINE(352)
					::String tmp29 = (haxelib + slash);		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(352)
					::String tmp30 = (tmp29 + HX_HCSTRING("ndll","\x36","\xb8","\x01","\x49"));		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(352)
					::String tmp31 = slash;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(352)
					::String tmp32 = (tmp30 + tmp31);		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(352)
					::String tmp33 = ::lime::_system::System_obj::sysName();		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(352)
					::String tmp34 = (tmp32 + tmp33);		HX_STACK_VAR(tmp34,"tmp34");
					HX_STACK_LINE(352)
					::String tmp35 = slash;		HX_STACK_VAR(tmp35,"tmp35");
					HX_STACK_LINE(352)
					...
					HX_STACK_LINE(352)
					::String tmp40 = method;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(352)
					int tmp41 = args;		HX_STACK_VAR(tmp41,"tmp41");
					HX_STACK_LINE(352)
					Dynamic tmp42 = ::lime::_system::System_obj::tryLoad(tmp38,tmp39,tmp40,tmp41);		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(352)
					result = tmp42;
					HX_STACK_LINE(354)
					bool tmp43 = (result == null());		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(354)
					if ((tmp43)){
						HX_STACK_LINE(356)
						::String tmp44 = (haxelib + slash);		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(356)
						::String tmp45 = (tmp44 + HX_HCSTRING("ndll","\x36","\xb8","\x01","\x49"));		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(356)
						::String tmp46 = slash;		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(356)
						::String tmp47 = (tmp45 + tmp46);		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(356)
						::String tmp48 = ::lime::_system::System_obj::sysName();		HX_STACK_VAR(tmp48,"tmp48");
						HX_STACK_LINE(356)
						::String tmp49 = (tmp47 + tmp48);		HX_STACK_VAR(tmp49,"tmp49");
						HX_STACK_LINE(356)
						::String tmp50 = (tmp49 + HX_HCSTRING("64","\x3e","\x2f","\x00","\x00"));		HX_STACK_VAR(tmp50,"tmp50");
						HX_STACK_LINE(356)
						::String tmp51 = slash;		HX_STACK_VAR(tmp51,"tmp51");
						HX_STACK_LINE(356)
						::String tmp52 = (tmp50 + tmp51);		HX_STACK_VAR(tmp52,"tmp52");
						HX_STACK_LINE(356)
						::String tmp53 = library;		HX_STACK_VAR(tmp53,"tmp53");
						HX_STACK_LINE(356)
						::String tmp54 = (tmp52 + tmp53);		HX_STACK_VAR(tmp54,"tmp54");
						HX_STACK_LINE(356)
						::String tmp55 = library;		HX_STACK_VAR(tmp55,"tmp55");
						HX_STACK_LINE(356)
						::String tmp56 = method;		HX_STACK_VAR(tmp56,"tmp56");
						HX_STACK_LINE(356)
						int tmp57 = args;		HX_STACK_VAR(tmp57,"tmp57");
						HX_STACK_LINE(356)
						Dynamic tmp58 = ::lime::_system::System_obj::tryLoad(tmp54,tmp55,tmp56,tmp57);		HX_STACK_VAR(tmp58,"tmp58");
						HX_STACK_LINE(356)
						result = tmp58;
					}
				}
			...
			HX_STACK_LINE(364)
			Dynamic tmp22 = result;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(364)
			::String tmp23 = ::Std_obj::string(tmp22);		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(364)
			::String tmp24 = (HX_HCSTRING("Result : ","\xe9","\x19","\x2c","\x14") + tmp23);		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(364)
			::lime::_system::System_obj::loaderTrace(tmp24);
		}
		HX_STACK_LINE(383)
