...
class HXCPP_CLASS_ATTRIBUTES  ThreadPool_obj : public hx::Object{
	...
	public:
		...
		int currentThreads;
		::lime::app::Event doWork;
		int maxThreads;
		int minThreads;
		::lime::app::Event onComplete;
		::lime::app::Event onError;
		::lime::app::Event onProgress;
		int __workCompleted;
		::cpp::vm::Deque __workIncoming;
		int __workQueued;
		::cpp::vm::Deque __workResult;
		virtual Void queue( ::String id,Dynamic message);
		Dynamic queue_dyn();

		virtual Void sendComplete( ::String id,Dynamic message);
		Dynamic sendComplete_dyn();

		virtual Void sendError( ::String id,Dynamic message);
		Dynamic sendError_dyn();

		virtual Void sendProgress( ::String id,Dynamic message);
