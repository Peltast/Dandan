...
class HXCPP_CLASS_ATTRIBUTES  GraphicsGradientFill_obj : public hx::Object{
	public:
		...
		Void __construct(::openfl::display::GradientType type,Array< int > colors,Array< Float > alphas,Array< Float > ratios,::openfl::geom::Matrix matrix,::openfl::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,hx::Null< Float >  __o_focalPointRatio);
	...
	public:
		...
		static hx::ObjectPtr< GraphicsGradientFill_obj > __new(::openfl::display::GradientType type,Array< int > colors,Array< Float > alphas,Array< Float > ratios,::openfl::geom::Matrix matrix,::openfl::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,hx::Null< Float >  __o_focalPointRatio);
