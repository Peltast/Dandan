...
class HXCPP_CLASS_ATTRIBUTES  Gamepad_obj : public hx::Object{
	...
	public:
		...
		bool connected;
		int id;
		::lime::app::Event onAxisMove;
		::lime::app::Event onButtonDown;
		::lime::app::Event onButtonUp;
		::lime::app::Event onDisconnect;
