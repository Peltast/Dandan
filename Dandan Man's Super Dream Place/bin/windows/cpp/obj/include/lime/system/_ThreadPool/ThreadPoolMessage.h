...
class HXCPP_CLASS_ATTRIBUTES  ThreadPoolMessage_obj : public hx::Object{
	public:
		...
		Void __construct(::lime::_system::_ThreadPool::ThreadPoolMessageType type,::String id,Dynamic message);
	...
	public:
		...
		static hx::ObjectPtr< ThreadPoolMessage_obj > __new(::lime::_system::_ThreadPool::ThreadPoolMessageType type,::String id,Dynamic message);
