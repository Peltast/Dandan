...
class HXCPP_CLASS_ATTRIBUTES  Attack_obj : public hx::Object{
	public:
		...
		Attack_obj();
		Void __construct(::actors::ObjectMover attackMovement,Array< ::Dynamic > hits,int duration,int damage,int stunDuration,::String __o_animation,::String __o_stunAnimation,hx::Null< bool >  __o_unstoppable,hx::Null< int >  __o_hitDuration);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="actors.attacks.Attack")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< Attack_obj > __new(::actors::ObjectMover attackMovement,Array< ::Dynamic > hits,int duration,int damage,int stunDuration,::String __o_animation,::String __o_stunAnimation,hx::Null< bool >  __o_unstoppable,hx::Null< int >  __o_hitDuration);
