...
class HXCPP_CLASS_ATTRIBUTES  ObjectMover_obj : public hx::Object{
	public:
		...
		ObjectMover_obj();
		Void __construct(Float xAcc,Float yAcc,int targetXVel,int targetYVel,Float xVel,Float yVel,int maxSpeedX,int maxSpeedY,int jumpCharges,hx::Null< int >  __o_gravity,hx::Null< bool >  __o_takesInput,hx::Null< bool >  __o_obeysGravity);

	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="actors.ObjectMover")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< ObjectMover_obj > __new(Float xAcc,Float yAcc,int targetXVel,int targetYVel,Float xVel,Float yVel,int maxSpeedX,int maxSpeedY,int jumpCharges,hx::Null< int >  __o_gravity,hx::Null< bool >  __o_takesInput,hx::Null< bool >  __o_obeysGravity);
