...
class HXCPP_CLASS_ATTRIBUTES  Actor_obj : public ::maps::mapobjects::MapObject_obj{
	...
	public:
		...
		::actors::Animation deathAnimation;
		...
		virtual Void checkDeathAnimation( );
		Dynamic checkDeathAnimation_dyn();

		virtual Void handleDeath( );
		Dynamic handleDeath_dyn();
		...
		virtual Void damageKnockback( ::maps::mapobjects::MapObject source);
		Dynamic damageKnockback_dyn();
