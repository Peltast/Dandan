...
HX_STACK_ARG(homeSpawn,"homeSpawn")
{
	...
	HX_STACK_LINE(33)
	::actors::Animation tmp4 = ::actors::Animation_obj::__new(HX_HCSTRING("LeftIdle","\xdb","\xa6","\x60","\x26"),(int)0,tmp,tmp1,tmp2,Array_obj< ::Dynamic >::__new().Add(tmp3),null(),null());		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(33)
	...
	HX_STACK_LINE(35)
	::actors::Animation tmp9 = ::actors::Animation_obj::__new(HX_HCSTRING("RightIdle","\xf0","\xdc","\x4c","\x52"),(int)0,tmp5,tmp6,tmp7,Array_obj< ::Dynamic >::__new().Add(tmp8),null(),null());		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(35)
	...
	HX_STACK_LINE(38)
	::actors::Animation tmp17 = ::actors::Animation_obj::__new(HX_HCSTRING("LeftWalk","\xd0","\x5c","\x9f","\x2f"),(int)3,tmp10,tmp11,tmp12,Array_obj< ::Dynamic >::__new().Add(tmp13).Add(tmp14).Add(tmp15).Add(tmp16),null(),null());		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(38)
	...
	HX_STACK_LINE(40)
	::actors::Animation tmp25 = ::actors::Animation_obj::__new(HX_HCSTRING("RightWalk","\xe5","\x92","\x8b","\x5b"),(int)3,tmp18,tmp19,tmp20,Array_obj< ::Dynamic >::__new().Add(tmp21).Add(tmp22).Add(tmp23).Add(tmp24),null(),null());		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(40)
	...
	HX_STACK_LINE(43)
	::actors::Animation tmp34 = ::actors::Animation_obj::__new(HX_HCSTRING("LeftWindup","\xaa","\x58","\x4e","\x78"),(int)1,tmp27,tmp28,tmp29,Array_obj< ::Dynamic >::__new().Add(tmp30).Add(tmp31).Add(tmp32).Add(tmp33),null(),null());		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(43)
	...
	HX_STACK_LINE(45)
	::actors::Animation tmp43 = ::actors::Animation_obj::__new(HX_HCSTRING("RightWindup","\xff","\xfd","\x43","\xa0"),(int)1,tmp36,tmp37,tmp38,Array_obj< ::Dynamic >::__new().Add(tmp39).Add(tmp40).Add(tmp41).Add(tmp42),null(),null());		HX_STACK_VAR(tmp43,"tmp43");
	HX_STACK_LINE(45)
	...
	HX_STACK_LINE(48)
	::actors::Animation tmp50 = ::actors::Animation_obj::__new(HX_HCSTRING("LeftAttack","\x4f","\xbb","\xd1","\x05"),(int)1,tmp45,tmp46,tmp47,Array_obj< ::Dynamic >::__new().Add(tmp48).Add(tmp49),null(),null());		HX_STACK_VAR(tmp50,"tmp50");
	HX_STACK_LINE(48)
	...
	HX_STACK_LINE(50)
	::actors::Animation tmp60 = ::actors::Animation_obj::__new(HX_HCSTRING("RightAttack","\xa4","\x60","\xc7","\x2d"),(int)1,tmp55,tmp56,tmp57,Array_obj< ::Dynamic >::__new().Add(tmp58).Add(tmp59),null(),null());		HX_STACK_VAR(tmp60,"tmp60");
	HX_STACK_LINE(50)
	...
	HX_STACK_LINE(66)
	::actors::ObjectMover tmp63 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),(int)0,(int)0,(int)0,(int)0,(int)2,(int)60,(int)2,null(),null(),null());		HX_STACK_VAR(tmp63,"tmp63");
	HX_STACK_LINE(66)
	...
	hitBoxes->push(tmp75);
	HX_STACK_LINE(76)
	::actors::ObjectMover tmp76 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),(int)0,(int)0,(int)0,(int)0,(int)0,(int)0,(int)0,(int)5,false,null());		HX_STACK_VAR(tmp76,"tmp76");
	HX_STACK_LINE(76)
	::actors::attacks::Attack tmp77 = ::actors::attacks::Attack_obj::__new(tmp76,hitBoxes,(int)-1,(int)1,(int)0,HX_HCSTRING("Attack","\xe8","\x6f","\xa4","\x14"),HX_HCSTRING("","\x00","\x00","\x00","\x00"),true,null());		HX_STACK_VAR(tmp77,"tmp77");
	HX_STACK_LINE(76)
