...
HX_STACK_ARG(spawnPoint,"spawnPoint")
{
	...
	HX_STACK_LINE(28)
	::actors::Animation tmp12 = ::actors::Animation_obj::__new(HX_HCSTRING("RightIdle","\xf0","\xdc","\x4c","\x52"),(int)4,tmp7,tmp8,tmp9,Array_obj< ::Dynamic >::__new().Add(tmp10).Add(tmp11),null(),null());		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(28)
	...
	HX_STACK_LINE(31)
	::actors::Animation tmp20 = ::actors::Animation_obj::__new(HX_HCSTRING("LeftFire","\x7d","\xd3","\x68","\x24"),(int)2,tmp13,tmp14,tmp15,Array_obj< ::Dynamic >::__new().Add(tmp16).Add(tmp17).Add(tmp18).Add(tmp19),null(),null());		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(31)
	...
	HX_STACK_LINE(33)
	::actors::Animation tmp29 = ::actors::Animation_obj::__new(HX_HCSTRING("RightFire","\x92","\x09","\x55","\x50"),(int)2,tmp22,tmp23,tmp24,Array_obj< ::Dynamic >::__new().Add(tmp25).Add(tmp26).Add(tmp27).Add(tmp28),null(),null());		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(33)
	...
	HX_STACK_LINE(43)
	::actors::ObjectMover tmp31 = ::actors::ObjectMover_obj::__new(((Float).1),((Float).1),(int)0,(int)0,(int)0,(int)0,(int)2,(int)60,(int)2,null(),null(),null());		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(43)
	...
	HX_STACK_LINE(54)
	::actors::ObjectMover tmp38 = ::actors::ObjectMover_obj::__new(((Float).5),((Float).1),(int)10,(int)0,(int)0,(int)0,(int)10,(int)0,(int)0,(int)0,false,null());		HX_STACK_VAR(tmp38,"tmp38");
	HX_STACK_LINE(53)
