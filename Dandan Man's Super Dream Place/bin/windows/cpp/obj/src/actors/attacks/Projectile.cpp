...
HX_STACK_ARG(damage,"damage")
{
	...
	HX_STACK_LINE(30)
	::actors::Animation tmp5 = ::actors::Animation_obj::__new(HX_HCSTRING("Left","\x27","\x34","\x89","\x32"),(int)1,tmp1,(int)24,(int)24,Array_obj< ::Dynamic >::__new().Add(tmp2).Add(tmp3).Add(tmp4),null(),null());		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(30)
	...
	HX_STACK_LINE(31)
	::actors::Animation tmp10 = ::actors::Animation_obj::__new(HX_HCSTRING("Right","\xbc","\x7b","\x91","\x7c"),(int)1,tmp6,(int)24,(int)24,Array_obj< ::Dynamic >::__new().Add(tmp7).Add(tmp8).Add(tmp9),null(),null());		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(31)
