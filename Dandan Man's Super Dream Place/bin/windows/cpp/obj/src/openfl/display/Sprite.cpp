...
bool Sprite_obj::__hitTest( Float x,Float y,bool shapeFlag,Array< ::Dynamic > stack,bool interactiveOnly){
	...
	HX_STACK_LINE(174)
	bool tmp12 = this->super::__hitTest(tmp8,tmp9,tmp10,stack,tmp11);		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(174)
	if ((tmp12)){
		HX_STACK_LINE(176)
		bool tmp13 = interactiveOnly;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(176)
		return tmp13;
	}
	else{
		...
		if ((tmp19)){
			HX_STACK_LINE(178)
			::openfl::display::Graphics tmp21 = this->__graphics;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(178)
			::openfl::display::Graphics tmp22 = tmp21;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(178)
			::openfl::display::Graphics tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(178)
			tmp20 = (tmp23 != null());
		}
		else{
		...
		if ((tmp20)){
			HX_STACK_LINE(178)
			::openfl::display::Graphics tmp22 = this->__graphics;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(178)
			::openfl::display::Graphics tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(178)
			...
			HX_STACK_LINE(178)
			bool tmp26 = shapeFlag;		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(178)
			::openfl::geom::Matrix tmp27 = this->__getTransform();		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(178)
			::openfl::geom::Matrix tmp28 = tmp27;		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(178)
			Float tmp29 = tmp24;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(178)
			Float tmp30 = tmp25;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(178)
			bool tmp31 = tmp26;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(178)
			::openfl::geom::Matrix tmp32 = tmp28;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(178)
			tmp21 = tmp23->__hitTest(tmp29,tmp30,tmp31,tmp32);
		}
		else{
			HX_STACK_LINE(178)
			tmp21 = false;
		...
		if ((tmp21)){
			HX_STACK_LINE(180)
			bool tmp22 = (stack != null());		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(180)
			if ((tmp22)){
				HX_STACK_LINE(182)
...
::openfl::display::Graphics Sprite_obj::get_graphics( ){
	HX_STACK_FRAME("openfl.display.Sprite","get_graphics",0x451134b3,"openfl.display.Sprite.get_graphics","openfl/display/Sprite.hx",202,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_LINE(204)
...
bool Sprite_obj::get_tabEnabled( ){
	HX_STACK_FRAME("openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",216,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_LINE(218)
