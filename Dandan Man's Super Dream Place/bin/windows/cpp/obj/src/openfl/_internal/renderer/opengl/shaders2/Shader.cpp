...
Void Shader_obj::enableVertexAttribute( ::openfl::_internal::renderer::opengl::utils::VertexAttribute attribute,int stride,int offset){
{
		...
		{
			HX_STACK_LINE(75)
			int size = attribute->components;		HX_STACK_VAR(size,"size");
			HX_STACK_LINE(75)
			int type = attribute->type;		HX_STACK_VAR(type,"type");
			HX_STACK_LINE(75)
			int tmp2 = (offset * (int)4);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(75)
			int offset1 = tmp2;		HX_STACK_VAR(offset1,"offset1");
			HX_STACK_LINE(75)
			{
				HX_STACK_LINE(75)
				bool tmp3 = attribute->normalized;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(75)
				if ((tmp3)){
					HX_STACK_LINE(75)
					...
					HX_STACK_LINE(75)
					int tmp7 = stride;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(75)
					int tmp8 = offset1;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(75)
					::lime::graphics::opengl::GL_obj::lime_gl_vertex_attrib_pointer_1(tmp4,tmp5,tmp6,tmp7,tmp8);
				}
				else{
					HX_STACK_LINE(75)
					int tmp4 = location;		HX_STACK_VAR(tmp4,"tmp4");
					...
					int tmp8 = offset1;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(75)
					::lime::graphics::opengl::GL_obj::lime_gl_vertex_attrib_pointer_2(tmp4,tmp5,tmp6,tmp7,tmp8);
				}
			}
		}
	}
			...
			switch( (int)(tmp3)){
				case (int)1: {
					...
					HX_STACK_LINE(84)
					{
						...
						HX_STACK_LINE(84)
						::haxe::io::Bytes tmp6 = values->buffer;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(84)
