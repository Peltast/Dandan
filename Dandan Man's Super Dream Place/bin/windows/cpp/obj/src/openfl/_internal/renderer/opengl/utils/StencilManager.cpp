...
Void StencilManager_obj::prepareGraphics( ::openfl::_internal::renderer::opengl::utils::GLBucketData fill,::openfl::_internal::renderer::RenderSession renderSession,::lime::utils::ArrayBufferView translationMatrix){
{
		...
		HX_STACK_LINE(45)
		{
			...
			HX_STACK_LINE(45)
			{
				...
				HX_STACK_LINE(45)
				::haxe::io::Bytes tmp4 = translationMatrix->buffer;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(45)
		...
		HX_STACK_LINE(46)
		{
			...
			HX_STACK_LINE(46)
			{
				...
				HX_STACK_LINE(46)
				::haxe::io::Bytes tmp5 = v->buffer;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(46)
				...
				HX_STACK_LINE(69)
				{
					...
					HX_STACK_LINE(69)
					{
						...
						HX_STACK_LINE(69)
						{
							...
							HX_STACK_LINE(69)
							::haxe::io::Bytes tmp10 = translationMatrix->buffer;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(69)
					...
					HX_STACK_LINE(69)
					{
						...
						HX_STACK_LINE(69)
						{
							...
							HX_STACK_LINE(69)
							::haxe::io::Bytes tmp11 = v->buffer;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(69)
