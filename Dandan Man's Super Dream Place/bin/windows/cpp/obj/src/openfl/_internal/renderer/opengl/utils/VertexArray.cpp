...
Void VertexArray_obj::upload( ::lime::utils::ArrayBufferView view){
{
		...
		int tmp1 = tmp->ARRAY_BUFFER;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(40)
		::haxe::io::Bytes tmp2 = view->buffer;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(40)
		int tmp3 = view->byteOffset;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(40)
		int tmp4 = view->byteLength;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(40)
...
Void VertexArray_obj::setContext( ::lime::graphics::GLRenderContext gl,::lime::utils::ArrayBufferView view){
{
		...
		HX_STACK_LINE(55)
		{
			...
			HX_STACK_LINE(55)
			::haxe::io::Bytes tmp4 = view->buffer;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(55)
			int tmp5 = view->byteOffset;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(55)
			int tmp6 = view->byteLength;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(55)
