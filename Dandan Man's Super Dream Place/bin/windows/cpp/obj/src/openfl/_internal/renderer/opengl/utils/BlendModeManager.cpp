	...
	HX_STACK_ARG(force,"force")
{
		...
		switch( (int)(blendMode->__Index())){
			case (int)0: {
				...
				HX_STACK_LINE(52)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)1);
			}
			;break;
			case (int)9: {
				HX_STACK_LINE(56)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32774);
				HX_STACK_LINE(57)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)774,(int)771);
			}
			;break;
			case (int)12: {
				HX_STACK_LINE(61)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32774);
				HX_STACK_LINE(62)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)769);
			}
			;break;
			case (int)13: {
				HX_STACK_LINE(66)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32779);
				HX_STACK_LINE(67)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)1);
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(72)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32775);
				HX_STACK_LINE(73)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)1);
			}
			;break;
			case (int)8: {
				HX_STACK_LINE(77)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32776);
				HX_STACK_LINE(78)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)1);
			}
			;break;
			default: {
				...
				::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32774);
				HX_STACK_LINE(84)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func((int)1,(int)771);
			}
		}
		HX_STACK_LINE(88)
		return true;
