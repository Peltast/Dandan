	...
	HX_STACK_ARG(transposedMatrix,"transposedMatrix")
{
		...
		HX_STACK_LINE(406)
		{
			...
			HX_STACK_LINE(406)
			::lime::utils::ArrayBufferView v = tmp4;		HX_STACK_VAR(v,"v");
			HX_STACK_LINE(406)
	...
	HX_STACK_ARG(format,"format")
{
		...
		{
			HX_STACK_LINE(545)
			int tmp6 = (buffer->data32PerVertex * numBytes);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(545)
			int stride = tmp6;		HX_STACK_VAR(stride,"stride");
			HX_STACK_LINE(545)
			int tmp7 = (bufferOffset * numBytes);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(545)
			...
			HX_STACK_LINE(545)
			{
				...
				int tmp8 = location;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(545)
				int tmp9 = dimension;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(545)
				int tmp10 = type;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(545)
				int tmp11 = stride;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(545)
				int tmp12 = offset;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(545)
				::lime::graphics::opengl::GL_obj::lime_gl_vertex_attrib_pointer_2(tmp8,tmp9,tmp10,tmp11,tmp12);
			}
		}
	}
return null();
		...
		if ((tmp3)){
			...
			switch( (int)(mipfilter->__Index())){
				...
				case (int)2: {
					...
					HX_STACK_LINE(853)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,tmp5);
				}
				;break;
			}
		}
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(902)
				{
					...
					HX_STACK_LINE(902)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,tmp7);
				}
			}
			else{
				HX_STACK_LINE(904)
				...
				if ((tmp7)){
					...
					switch( (int)(mipfilter->__Index())){
						...
						case (int)2: {
							...
							HX_STACK_LINE(972)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10241,tmp9);
						}
						;break;
					}
				}
