...
Void IndexBuffer3D_obj::uploadFromByteArray( ::lime::utils::ByteArray byteArray,int byteArrayOffset,int startOffset,int count){
{
		...
		{
			HX_STACK_LINE(58)
			::haxe::io::Bytes tmp5 = indices->buffer;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(58)
			int tmp6 = indices->byteOffset;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(58)
			int tmp7 = indices->byteLength;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(58)
...
Void IndexBuffer3D_obj::uploadFromVector( Array< int > data,int startOffset,int count){
{
		...
		{
			HX_STACK_LINE(80)
			::haxe::io::Bytes tmp1 = indices->buffer;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(80)
			int tmp2 = indices->byteOffset;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(80)
			int tmp3 = indices->byteLength;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(80)
