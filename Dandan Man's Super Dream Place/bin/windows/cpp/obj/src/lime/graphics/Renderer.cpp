...
HX_STACK_ARG(window,"window")
{
	...
	HX_STACK_LINE(13)
	this->onContextRestored = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(12)
	this->onContextLost = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(22)
	this->window = window;
	HX_STACK_LINE(24)
...
Dynamic Renderer_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"onContextLost") ) { onContextLost=inValue.Cast< ::lime::app::Event >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"onContextRestored") ) { onContextRestored=inValue.Cast< ::lime::app::Event >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(Renderer_obj,onContextLost),HX_HCSTRING("onContextLost","\x94","\xac","\xa5","\x87")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(Renderer_obj,onContextRestored),HX_HCSTRING("onContextRestored","\x06","\x18","\x47","\xe2")},
