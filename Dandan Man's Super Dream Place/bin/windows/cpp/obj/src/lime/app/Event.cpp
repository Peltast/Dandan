...
bool Event_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",77,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(79)
	{
...
{
		HX_STACK_FRAME("lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",90,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(92)
