...
{
HX_STACK_FRAME("lime.app.Preloader","new",0x922e2422,"lime.app.Preloader.new","lime/app/Preloader.hx",21,0xcf198510)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(26)
	...
	HX_STACK_LINE(44)
	::lime::app::Event tmp = this->onProgress;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("lime.app.Preloader","create",0x6b66587a,"lime.app.Preloader.create","lime/app/Preloader.hx",64,0xcf198510)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Preloader","load",0x54e69024,"lime.app.Preloader.load","lime/app/Preloader.hx",71,0xcf198510)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Preloader","start",0xfff3bca4,"lime.app.Preloader.start","lime/app/Preloader.hx",225,0xcf198510)
		HX_STACK_THIS(this)
		HX_STACK_LINE(227)
		this->complete = true;
		HX_STACK_LINE(50)
		{
			HX_STACK_LINE(237)
			::lime::app::Event tmp = this->onComplete;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(52)
			cpp::ArrayBase listeners = tmp->listeners;		HX_STACK_VAR(listeners,"listeners");
			HX_STACK_LINE(237)
			::lime::app::Event tmp1 = this->onComplete;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(53)
			...
			while((true)){
				...
				if ((tmp6)){
					HX_STACK_LINE(237)
					::lime::app::Event tmp7 = this->onComplete;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(62)
...
{
		HX_STACK_FRAME("lime.app.Preloader","update",0x765c7787,"lime.app.Preloader.update","lime/app/Preloader.hx",242,0xcf198510)
		HX_STACK_THIS(this)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(Preloader_obj,onComplete),HX_HCSTRING("onComplete","\xf8","\xd4","\x7e","\x5d")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(Preloader_obj,onProgress),HX_HCSTRING("onProgress","\xec","\xcb","\xe1","\x63")},
	{ hx::fsUnknown, 0, null()}
};
