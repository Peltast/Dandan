...
{
		HX_STACK_FRAME("lime.system.BackgroundWorker","__doWork",0x193122d8,"lime.system.BackgroundWorker.__doWork","lime/app/Event.hx",50,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(140)
		::lime::app::Event tmp = this->doWork;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(52)
		cpp::ArrayBase listeners = tmp->listeners;		HX_STACK_VAR(listeners,"listeners");
		HX_STACK_LINE(140)
		::lime::app::Event tmp1 = this->doWork;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(53)
		Array< bool > repeat = tmp1->repeat;		HX_STACK_VAR(repeat,"repeat");
		HX_STACK_LINE(54)
		...
		while((true)){
			...
			HX_STACK_LINE(140)
			Dynamic tmp5 = this->__runMessage;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(58)
			tmp4(tmp5).Cast< Void >();
			HX_STACK_LINE(60)
			...
			if ((tmp7)){
				HX_STACK_LINE(140)
				::lime::app::Event tmp8 = this->doWork;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(62)
		...
		if ((tmp2)){
			...
			if ((tmp5)){
				...
				if ((tmp9)){
					...
					{
						HX_STACK_LINE(175)
						::lime::app::Event tmp10 = this->onError;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(52)
						cpp::ArrayBase listeners = tmp10->listeners;		HX_STACK_VAR(listeners,"listeners");
						HX_STACK_LINE(175)
						::lime::app::Event tmp11 = this->onError;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(53)
						Array< bool > repeat = tmp11->repeat;		HX_STACK_VAR(repeat,"repeat");
						HX_STACK_LINE(54)
						int i = (int)0;		HX_STACK_VAR(i,"i");
						HX_STACK_LINE(56)
						while((true)){
							HX_STACK_LINE(56)
							bool tmp12 = (i < listeners->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(56)
							...
							HX_STACK_LINE(175)
							::cpp::vm::Deque tmp15 = this->__messageQueue;		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(175)
							Dynamic tmp16 = tmp15->pop(false);		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(58)
							tmp14(tmp16).Cast< Void >();
							HX_STACK_LINE(60)
							...
							if ((tmp18)){
								HX_STACK_LINE(175)
								::lime::app::Event tmp19 = this->onError;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(62)
				...
				if ((tmp8)){
					...
					if ((tmp12)){
						...
						{
							HX_STACK_LINE(186)
							::lime::app::Event tmp13 = this->onComplete;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(52)
							cpp::ArrayBase listeners = tmp13->listeners;		HX_STACK_VAR(listeners,"listeners");
							HX_STACK_LINE(186)
							::lime::app::Event tmp14 = this->onComplete;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(53)
							Array< bool > repeat = tmp14->repeat;		HX_STACK_VAR(repeat,"repeat");
							HX_STACK_LINE(54)
							int i = (int)0;		HX_STACK_VAR(i,"i");
							HX_STACK_LINE(56)
							while((true)){
								...
								HX_STACK_LINE(186)
								::cpp::vm::Deque tmp18 = this->__messageQueue;		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(186)
								Dynamic tmp19 = tmp18->pop(false);		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(58)
								tmp17(tmp19).Cast< Void >();
								HX_STACK_LINE(60)
								...
								if ((tmp21)){
									HX_STACK_LINE(186)
									::lime::app::Event tmp22 = this->onComplete;		HX_STACK_VAR(tmp22,"tmp22");
									HX_STACK_LINE(62)
					...
					if ((tmp10)){
						HX_STACK_LINE(194)
						::lime::app::Event tmp11 = this->onProgress;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(52)
						cpp::ArrayBase listeners = tmp11->listeners;		HX_STACK_VAR(listeners,"listeners");
						HX_STACK_LINE(194)
						::lime::app::Event tmp12 = this->onProgress;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(53)
						Array< bool > repeat = tmp12->repeat;		HX_STACK_VAR(repeat,"repeat");
						HX_STACK_LINE(54)
						int i = (int)0;		HX_STACK_VAR(i,"i");
						HX_STACK_LINE(56)
						while((true)){
							...
							HX_STACK_LINE(194)
							Dynamic tmp16 = message;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(58)
							tmp15(tmp16).Cast< Void >();
							HX_STACK_LINE(60)
							bool tmp17 = repeat->__get(i);		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(60)
							bool tmp18 = !(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
							...
							if ((tmp18)){
								HX_STACK_LINE(194)
								::lime::app::Event tmp19 = this->onProgress;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(62)
								Dynamic tmp20 = listeners->__GetItem(i);		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(62)
								tmp19->remove(tmp20);
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(BackgroundWorker_obj,doWork),HX_HCSTRING("doWork","\xfc","\xa6","\x00","\x1f")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(BackgroundWorker_obj,onComplete),HX_HCSTRING("onComplete","\xf8","\xd4","\x7e","\x5d")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(BackgroundWorker_obj,onError),HX_HCSTRING("onError","\x29","\x6a","\x67","\x09")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(BackgroundWorker_obj,onProgress),HX_HCSTRING("onProgress","\xec","\xcb","\xe1","\x63")},
