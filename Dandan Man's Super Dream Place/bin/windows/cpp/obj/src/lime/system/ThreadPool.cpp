...
int maxThreads = __o_maxThreads.Default(1);
{
	...
	HX_STACK_LINE(25)
	this->onProgress = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(24)
	this->onError = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(23)
	this->onComplete = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(20)
	this->doWork = ::lime::app::Event_obj::__new();
	HX_STACK_LINE(37)
...
Void ThreadPool_obj::queue( ::String id,Dynamic message){
{
		...
		HX_STACK_LINE(68)
		::lime::_system::_ThreadPool::ThreadPoolMessage tmp1 = ::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::WORK,id,message);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(68)
		tmp->add(tmp1);
		HX_STACK_LINE(69)
		(this->__workQueued)++;
...
HX_DEFINE_DYNAMIC_FUNC2(ThreadPool_obj,queue,(void))

Void ThreadPool_obj::sendComplete( ::String id,Dynamic message){
{
		...
		HX_STACK_LINE(96)
		::lime::_system::_ThreadPool::ThreadPoolMessage tmp1 = ::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE,id,message);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(96)
		tmp->add(tmp1);
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(ThreadPool_obj,sendComplete,(void))

Void ThreadPool_obj::sendError( ::String id,Dynamic message){
{
		...
		::cpp::vm::Deque tmp = this->__workResult;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(107)
		::lime::_system::_ThreadPool::ThreadPoolMessage tmp1 = ::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR,id,message);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(107)
		tmp->add(tmp1);
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(ThreadPool_obj,sendError,(void))

Void ThreadPool_obj::sendProgress( ::String id,Dynamic message){
{
		...
		::cpp::vm::Deque tmp = this->__workResult;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(118)
		::lime::_system::_ThreadPool::ThreadPoolMessage tmp1 = ::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS,id,message);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(118)
		tmp->add(tmp1);
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(ThreadPool_obj,sendProgress,(void))
...
Void ThreadPool_obj::__doWork( ){
{
		...
		while((true)){
			...
			if ((tmp2)){
				HX_STACK_LINE(136)
				::lime::app::Event tmp3 = this->doWork;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(52)
				cpp::ArrayBase listeners = tmp3->listeners;		HX_STACK_VAR(listeners,"listeners");
				HX_STACK_LINE(136)
				::lime::app::Event tmp4 = this->doWork;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(53)
				Array< bool > repeat = tmp4->repeat;		HX_STACK_VAR(repeat,"repeat");
				HX_STACK_LINE(54)
				int i = (int)0;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(56)
				while((true)){
					HX_STACK_LINE(56)
					bool tmp5 = (i < listeners->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(56)
					...
					HX_STACK_LINE(136)
					::String tmp8 = message->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(136)
					Dynamic tmp9 = message->__Field(HX_HCSTRING("message","\xc7","\x35","\x11","\x9a"), hx::paccDynamic );		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(58)
					tmp7(tmp8,tmp9).Cast< Void >();
					HX_STACK_LINE(60)
					...
					if ((tmp11)){
						HX_STACK_LINE(136)
						::lime::app::Event tmp12 = this->doWork;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(62)
			...
			while((true)){
				...
				HX_STACK_LINE(157)
				{
					...
					switch( (int)(_g->__Index())){
						case (int)3: {
							HX_STACK_LINE(161)
							::lime::app::Event tmp7 = this->onProgress;		HX_STACK_VAR(tmp7,"tmp7");
							HX_STACK_LINE(52)
							cpp::ArrayBase listeners = tmp7->listeners;		HX_STACK_VAR(listeners,"listeners");
							HX_STACK_LINE(161)
							::lime::app::Event tmp8 = this->onProgress;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(53)
							Array< bool > repeat = tmp8->repeat;		HX_STACK_VAR(repeat,"repeat");
							HX_STACK_LINE(54)
							int i = (int)0;		HX_STACK_VAR(i,"i");
							HX_STACK_LINE(56)
							while((true)){
								...
								HX_STACK_LINE(161)
								::String tmp12 = message->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(161)
								Dynamic tmp13 = message->__Field(HX_HCSTRING("message","\xc7","\x35","\x11","\x9a"), hx::paccDynamic );		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(58)
								tmp11(tmp12,tmp13).Cast< Void >();
								HX_STACK_LINE(60)
								...
								if ((tmp15)){
									HX_STACK_LINE(161)
									::lime::app::Event tmp16 = this->onProgress;		HX_STACK_VAR(tmp16,"tmp16");
									HX_STACK_LINE(62)
						...
						case (int)0: case (int)1: {
							...
							if ((tmp13)){
								...
								HX_STACK_LINE(170)
								::lime::_system::_ThreadPool::ThreadPoolMessage tmp15 = ::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT,null(),null());		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(170)
								tmp14->add(tmp15);
							}
							HX_STACK_LINE(174)
							...
							if ((tmp14)){
								HX_STACK_LINE(176)
								::lime::app::Event tmp15 = this->onComplete;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(52)
								cpp::ArrayBase listeners = tmp15->listeners;		HX_STACK_VAR(listeners,"listeners");
								HX_STACK_LINE(176)
								::lime::app::Event tmp16 = this->onComplete;		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(53)
								Array< bool > repeat = tmp16->repeat;		HX_STACK_VAR(repeat,"repeat");
								HX_STACK_LINE(54)
								int i = (int)0;		HX_STACK_VAR(i,"i");
								HX_STACK_LINE(56)
								while((true)){
									HX_STACK_LINE(56)
									bool tmp17 = (i < listeners->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));		HX_STACK_VAR(tmp17,"tmp17");
									HX_STACK_LINE(56)
									...
									HX_STACK_LINE(176)
									::String tmp20 = message->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(176)
									Dynamic tmp21 = message->__Field(HX_HCSTRING("message","\xc7","\x35","\x11","\x9a"), hx::paccDynamic );		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(58)
									tmp19(tmp20,tmp21).Cast< Void >();
									HX_STACK_LINE(60)
									...
									if ((tmp23)){
										HX_STACK_LINE(176)
										::lime::app::Event tmp24 = this->onComplete;		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(62)
								...
								HX_STACK_LINE(180)
								::lime::app::Event tmp15 = this->onError;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(52)
								cpp::ArrayBase listeners = tmp15->listeners;		HX_STACK_VAR(listeners,"listeners");
								HX_STACK_LINE(180)
								::lime::app::Event tmp16 = this->onError;		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(53)
								Array< bool > repeat = tmp16->repeat;		HX_STACK_VAR(repeat,"repeat");
								HX_STACK_LINE(54)
								int i = (int)0;		HX_STACK_VAR(i,"i");
								...
								while((true)){
									...
									if ((tmp23)){
										HX_STACK_LINE(180)
										::lime::app::Event tmp24 = this->onError;		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(62)
										Dynamic tmp25 = listeners->__GetItem(i);		HX_STACK_VAR(tmp25,"tmp25");
										HX_STACK_LINE(62)
										tmp24->remove(tmp25);
...
Dynamic ThreadPool_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"doWork") ) { doWork=inValue.Cast< ::lime::app::Event >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"onError") ) { onError=inValue.Cast< ::lime::app::Event >(); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"onProgress") ) { onProgress=inValue.Cast< ::lime::app::Event >(); return inValue; }
		break;
	case 12:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(ThreadPool_obj,doWork),HX_HCSTRING("doWork","\xfc","\xa6","\x00","\x1f")},
	...
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(ThreadPool_obj,onComplete),HX_HCSTRING("onComplete","\xf8","\xd4","\x7e","\x5d")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(ThreadPool_obj,onError),HX_HCSTRING("onError","\x29","\x6a","\x67","\x09")},
	{hx::fsObject /*::lime::app::Event*/ ,(int)offsetof(ThreadPool_obj,onProgress),HX_HCSTRING("onProgress","\xec","\xcb","\xe1","\x63")},
